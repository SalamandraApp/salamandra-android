package com.android.salamandra.workouts.executeWk.data.di
...
import com.android.salamandra.workouts.executeWk.data.RepositoryImpl
...
object NetworkModule {
    ...
    fun provideRepository(
       ...
       return RepositoryImpl(salamandraApiService, dataStoreRepository, retrofitExceptionHandler)
    }
}